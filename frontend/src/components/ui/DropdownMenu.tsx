...
export default function DropdownMenu({ label, items, isOpen, onToggle, onOpen, onClose, variant = 'default', align = 'left', dividerBefore, onSelect, avatarText = 'P', profileSubtitle }: DropdownMenuProps): JSX.Element {
