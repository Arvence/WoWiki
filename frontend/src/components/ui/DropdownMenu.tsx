  ...
  return (
    <div className="relative" onMouseEnter={onOpen} onMouseLeave={onClose}>
      <button
        ...
        className={`inline-flex items-center justify-center rounded-md border text-sm font-medium text-text transition hover:border-primary hover:bg-background/90 ${isProfile ? 'h-10 w-10 rounded-full border-primary/40 bg-primary/10' : 'gap-1 border-border bg-background/80 px-3 py-2'}`}
      >
